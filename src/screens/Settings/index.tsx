...
const Settings = () => {
  ...
  return (
    <div>
      <Particles params={particlesParams} canvasClassName="settings-particles" />
      ...
      <div>
        <div className="settings-container">
          ...
          <div className="settings-fields-left" style={{ marginRight: 30 }}>
            {registerFormFields.slice(0, 3).map(({ label, id, type, validation }) => (
              <FormInput
          ...
          <div className="settings-fields-left">
            {registerFormFields.slice(3).map(({ label, id, type, validation }) => (
              <FormInput
                containerClassName="settings-field-container"
                inputClassName="settings-field-input"
                type={type}
