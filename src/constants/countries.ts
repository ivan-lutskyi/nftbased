export default [ 
  ...
  {label: "Korea, Democratic PeopleS Republic of", name: "KP"}, 
  {label: "Korea, Republic of", name: "KR"}, 
  {label: "Kuwait", name: "KW"}, 
  {label: "Kyrgyzstan", name: "KG"}, 
  {label: "Lao PeopleS Democratic Republic", name: "LA"}, 
